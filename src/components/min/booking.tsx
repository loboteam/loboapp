...
const Booking: React.FC<{data: BookingContainer}> = ({data}) =>{
    ...
    const D = new Date();
    const done = d.getFullYear() < D.getFullYear() || d.getMonth() < D.getMonth() || d.getDate() < D.getDate() || data.from < D.getHours();
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <Badge variant="success">{data.cancelled ? "Cancelada" : done ? "Completada" : "Activa"}</Badge>
                </div>
            ...
            {!(data.cancelled || done) && <div className="flex gap-2">
